...
export default function Sidebar({ activePath = "/admin", onNavigate }) {
  return (
    <aside className="hidden lg:flex lg:w-64 shrink-0 flex-col border-r border-border-subtle bg-bg-sidebar px-4 py-6">
